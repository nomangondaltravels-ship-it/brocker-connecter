    ...
    if (mediaFor) {
      ...
      return json({
        ...
        details: {
          ...
          furnishedStatus: meta.furnishedStatus || 'fully_furnished',
          ...
          gymAvailable: Boolean(meta.gymAvailable),
          poolAvailable: Boolean(meta.poolAvailable),
          parkingAvailable: Boolean(meta.parkingAvailable),
          petsAvailable: Boolean(meta.petsAvailable),
          securityDeposit: meta.securityDeposit || '',
          paymentTerms: meta.paymentTerms || '',
          unitPermit: meta.unitPermit || '',
